...
import 'package:kasirtoko/modelbarang/barang.dart' ;
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(widget.barang.kode ?? '', style:
                  ...
                  Row(
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.only(left: 30),
                        child: Text(widget.barang.nama ?? '', style:
                        TextStyle(fontSize: 16)),
                      ),
                    ],
                  ),
                  ...
                  Row(
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.only(left: 30),
                        child: Text(widget.barang.satuan ?? '', style:
                        TextStyle(fontSize: 16)),
                      ),
                    ],
                  ),
